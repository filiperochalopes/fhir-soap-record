...
CREATE TABLE IF NOT EXISTS Patient (
  ...
  KEY idx_patient_merged_into (merged_into_patient_id),
  CONSTRAINT fk_patient_merged_into FOREIGN KEY (merged_into_patient_id) REFERENCES Patient(id) ON DELETE SET NULL ON UPDATE CASCADE
);
